...
## App features
1. Search by city/zip code 
2. Display forecast weather  
3. Open weather api integration (Integrated today and 5 days weather forecast)
...
[Angular 4 Style Guide](https://angular.io/guide/styleguide)
